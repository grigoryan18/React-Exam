  ...
  return (
   ...
   <section className='w-full h-[800px]' style={{background: "linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.6)), url('https://spreethemesprevious.github.io/bisum/img/hero.jpg') no-repeat center / cover" }}>
    <div className='w-full h-full flex justify-center items-center flex-col'>
      ...
      <div className='w-full h-auto flex justify-center items-center pt-[70px]'>
        <button className='w-[230px] h-[70px] bg-orange-700 text-white transition-all font-bold  hover:bg-[#1b7688bb]'>View Colections</button>
      </div>
    </div>
   </section>
   ...
   <section className='mt-24'>
      <div className='w-full h-[120px] bg-[#1b7688bb]'>
        <p className='text-4xl text-white text-center font-medium pt-[45px]'> RTL Demo Coming Soon.</p>
      </div>
   </section>
    </>
